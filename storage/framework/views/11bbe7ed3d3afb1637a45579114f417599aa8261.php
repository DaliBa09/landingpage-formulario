				...
				<div class="card-body">
					...
					<form action="login.php" method="POST">
						<div class="form-group">
							...
							<input type="text" required name="nombre" value="<?php echo e($persona); ?>" class="form-control">
							<label for="correo">Ingersa tu correo</label>
							<input type="email" required name="correo" value="<?php echo e($correo); ?>" class="form-control">
...
</html><?php /**PATH C:\laragon\www\comedor_logan\resources\views/contacto.blade.php ENDPATH**/ ?>